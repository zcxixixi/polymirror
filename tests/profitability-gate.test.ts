  ...
  return {
    ...
    performance: {
      ...
      winningConditionConcentration: {
        ...
        settledConditionCount: 100,
        winningConditionCount: 80,
        netConditionPnlUsd: 19.21,
        grossWinningConditionPnlUsd: 48,
        top1WinningConditionGrossProfitSharePct: 12.49,
        top2WinningConditionGrossProfitSharePct: 20,
        top3WinningConditionGrossProfitSharePct: 28,
        netPnlAfterRemovingTop1WinningConditionUsd: 16.81,
        netPnlAfterRemovingTop2WinningConditionsUsd: 14,
        netPnlAfterRemovingTop3WinningConditionsUsd: 10,
      },
    ...
    const gate = assessProfitabilityGate(
      report({
        performance: {
          ...
          winningConditionConcentration: {
            ...report().performance.winningConditionConcentration,
            top1WinningConditionGrossProfitSharePct: 82,
            top3WinningConditionGrossProfitSharePct: 94,
          },
